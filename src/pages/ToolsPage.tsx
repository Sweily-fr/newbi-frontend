...
import { Add, ArrowDown, ArrowDown2, ArrowUp2, Building, InfoCircle, LampOn, Verify } from 'iconsax-react';
                ...
                <div className="text-center">
                  <div className="flex justify-center items-center mb-6">
                    ...
                    <a
                      ...
                      className="ml-4 inline-flex items-center px-5 py-3 border border-gray-300 shadow-sm text-sm font-medium rounded-2xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#5b50ff]"
                    >
                  ...
                  <div className="flex justify-center mb-6">
                    <LampOn size="100" variant="Linear" color="rgba(91, 80, 255, 0.2)" />
                  </div>
