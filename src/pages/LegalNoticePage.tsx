...
export const LegalNoticePage: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <Helmet>
        <title>Mentions Légales | Génération Business</title>
        <meta name="description" content="Mentions légales de Génération Business - Informations légales sur notre société et notre site web." />
      </Helmet>
      ...
      <div className="bg-white shadow-md rounded-lg p-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 mb-3">
            Le site Génération Business est édité par la société Génération Business, SAS au capital de 1 000 euros, 
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 mb-3">
            Le site Génération Business est hébergé par OVH SAS, société au capital de 10 174 560 €,
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 mb-3">
            L'ensemble des éléments constituant le site Génération Business (textes, graphismes, logiciels, photographies, 
            images, vidéos, sons, plans, logos, marques, etc.) ainsi que le site lui-même, sont la propriété exclusive 
            de Génération Business ou de ses partenaires. Ces éléments sont protégés par les lois relatives à la propriété 
          ...
          <p className="text-gray-600 mb-3">
            ...
            partie des éléments du site sans l'accord écrit préalable de Génération Business est strictement interdite 
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 mb-3">
            Le site Génération Business utilise des cookies pour améliorer l'expérience utilisateur. Pour plus d'informations 
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 mb-3">
            Le site Génération Business peut contenir des liens hypertextes vers d'autres sites internet. 
            Génération Business n'exerce aucun contrôle sur ces sites et décline toute responsabilité quant à leur contenu.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600 mb-3">
            ...
            <a href="mailto:contact@generation-business.fr" className="text-blue-600 hover:underline ml-1">contact@generation-business.fr</a>
          </p>
        </section>
      </div>
    </div>
