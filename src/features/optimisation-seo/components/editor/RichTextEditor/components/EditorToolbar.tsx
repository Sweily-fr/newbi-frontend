        ...
        <div className="flex items-center">
          ...
          {isLinkSelected && (
            <button
              ...
              className={`p-1.5 rounded hover:bg-[#e6e1ff] transition-colors duration-200 ${isLinkSelected ? 'bg-[#d8d3ff]' : ''}`}
          ...
          <button 
            ...
            className={`p-1.5 rounded hover:bg-[#e6e1ff] transition-colors duration-200`}
