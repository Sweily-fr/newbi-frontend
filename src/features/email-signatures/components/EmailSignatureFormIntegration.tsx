...
import { useSaveSignature, useGetSignature } from '../hooks';
import { Notification } from '../../../components/common/Notification';

/**
 * Composant d'intégration pour le formulaire de signature
 * Ce composant préserve le visuel existant tout en ajoutant la logique d'enregistrement
 */
export const EmailSignatureFormIntegration: React.FC = () => {
