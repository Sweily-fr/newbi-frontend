...
export const SocialLinksComponent: React.FC<SocialLinksProps> = ({
  ...
  // Utiliser la couleur d'icône fournie ou blanc par défaut pour les styles avec fond, ou noir pour le style plain
  const svgIconColor = propIconColor || (socialLinksIconStyle === 'plain' ? '#333333' : '#ffffff');
