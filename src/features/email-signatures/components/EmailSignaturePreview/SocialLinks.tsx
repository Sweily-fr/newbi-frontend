...
export const SocialLinksComponent: React.FC<SocialLinksProps> = ({
  ...
  // Déterminer la couleur de remplissage des SVG
  // Pour les styles avec fond (rounded, circle), utiliser le blanc pour garantir la visibilité
  // Pour le style plain, utiliser la couleur définie
  const svgFillColor = socialLinksIconStyle === 'plain' ? iconColor : '#ffffff';
          ...
          {displayMode === 'icons' ? (
            <div style={getLinkStyle('linkedin').iconStyle}>
              <svg width="100%" height="100%" viewBox="0 0 24 24" style={{
                fill: svgFillColor, // Utiliser la couleur calculée pour garantir la cohérence
                display: 'block',
                maxWidth: '100%',
                maxHeight: '100%',
                boxSizing: 'border-box'
        ...
        >
          {displayMode === 'icons' ? (
            <div style={getLinkStyle('twitter').iconStyle || {}}>
              <svg width="14" height="14" viewBox="0 0 24 24" style={{fill: svgFillColor}}>
